...
echo 40 > "$RVE_CPU0_schedutil/hispeed_load"
echo 500 > "$RVE_CPU0_schedutil/up_rate_limit_us"
echo 25000 > "$RVE_CPU0_schedutil/down_rate_limit_us"
...
echo 40 > "$RVE_CPU4_schedutil/hispeed_load"
echo 500 > "$RVE_CPU4_schedutil/up_rate_limit_us"
echo 25000 > "$RVE_CPU4_schedutil/down_rate_limit_us"
...
# GPU
echo 520 > "$RVE_GPU/min_clock_mhz"
...
echo 520000000 > "$RVE_GPU_FREQ/min_freq"
