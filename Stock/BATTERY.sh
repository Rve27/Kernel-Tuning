...
echo 90 > "$RVE_CPU0_schedutil/hispeed_load"
echo 5000 > "$RVE_CPU0_schedutil/up_rate_limit_us"
echo 5000 > "$RVE_CPU0_schedutil/down_rate_limit_us"
echo 0 > "$RVE_CPU0_schedutil/iowait_boost_enable"

# CPU0 core_ctl
echo 1 > "$RVE_CPU0_CORE/enable"
echo 25 25 25 25 > "$RVE_CPU0_CORE/busy_down_thres"
echo 25 25 25 25 > "$RVE_CPU0_CORE/busy_up_thres"
echo 4 > "$RVE_CPU0_CORE/max_cpus"
echo 1 > "$RVE_CPU0_CORE/min_cpus"

# Big Cluster CPU4
echo "schedutil" > "$RVE_CPU4_FREQ/scaling_governor"
echo 1056000 > "$RVE_CPU4_FREQ/scaling_max_freq"
echo 825600 > "$RVE_CPU4_FREQ/scaling_min_freq"

# CPU4 schedutil
echo 1056000 > "$RVE_CPU4_schedutil/hispeed_freq"
echo 90 > "$RVE_CPU4_schedutil/hispeed_load"
echo 5000 > "$RVE_CPU4_schedutil/up_rate_limit_us"
echo 5000 > "$RVE_CPU4_schedutil/down_rate_limit_us"
echo 0 > "$RVE_CPU4_schedutil/iowait_boost_enable"

# CPU4 core_ctl
echo 1 > "$RVE_CPU4_CORE/enable"
echo 60 60 60 60 > "$RVE_CPU4_CORE/busy_down_thres"
echo 80 80 80 80 > "$RVE_CPU4_CORE/busy_up_thres"
echo 1 > "$RVE_CPU4_CORE/max_cpus"
...
echo 257 > "$RVE_GPU/max_clock_mhz"
echo 257000000 > "$RVE_GPU/max_gpuclk"
...
echo 0 > "$RVE_KERNEL/sched_cfs_boost"
