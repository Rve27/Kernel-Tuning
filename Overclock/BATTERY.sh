...
# CPU0 WALT
echo 1056000 > "$RVE_CPU0_walt/hispeed_freq"
echo 90 > "$RVE_CPU0_walt/hispeed_load"
echo 5000 > "$RVE_CPU0_walt/up_rate_limit_us"
echo 5000 > "$RVE_CPU0_walt/down_rate_limit_us"
...
# CPU4 WALT
echo 1056000 > "$RVE_CPU4_walt/hispeed_freq"
echo 90 > "$RVE_CPU4_walt/hispeed_load"
echo 5000 > "$RVE_CPU4_walt/up_rate_limit_us"
echo 5000 > "$RVE_CPU4_walt/down_rate_limit_us"
