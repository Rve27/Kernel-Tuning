...
RVE_CPU0s=/sys/devices/system/cpu/cpu0/cpufreq/schedutil
...
chmod 0644 "$RVE_CPU0s/exp_util"
chmod 0644 "$RVE_CPU0s/hispeed_freq"
chmod 0644 "$RVE_CPU0s/hispeed_load"
chmod 0644 "$RVE_CPU0s/up_rate_limit_us"
chmod 0644 "$RVE_CPU0s/down_rate_limit_us"
...
chmod 0644 "$RVE_CPU4s/exp_util"
chmod 0644 "$RVE_CPU4s/hispeed_freq"
chmod 0644 "$RVE_CPU4s/hispeed_load"
chmod 0644 "$RVE_CPU4s/up_rate_limit_us"
chmod 0644 "$RVE_CPU4s/down_rate_limit_us"
...
#Little Cluster CPU0
echo "schedutil" > "$RVE_CPU0f/scaling_governor"
echo 1228800 > "$RVE_CPU0f/scaling_max_freq"
echo 300000 > "$RVE_CPU0f/scaling_min_freq"

#CPU0 Schedutil
echo 0 > "$RVE_CPU0s/exp_util"
echo 1228800 > "$RVE_CPU0s/hispeed_freq"
echo 90 > "$RVE_CPU0s/hispeed_load"
echo 5000 > "$RVE_CPU0s/up_rate_limit_us"
echo 5000 > "$RVE_CPU0s/down_rate_limit_us"
...
#Little Cluster CPU4
echo "schedutil" > "$RVE_CPU4f/scaling_governor"
echo 1209600 > "$RVE_CPU4f/scaling_max_freq"
echo 825600 > "$RVE_CPU4f/scaling_min_freq"

#CPU4 Schedutil
echo 0 > "$RVE_CPU4s/exp_util"
echo 1209600 > "$RVE_CPU4s/hispeed_freq"
echo 90 > "$RVE_CPU4s/hispeed_load"
echo 5000 > "$RVE_CPU4s/up_rate_limit_us"
echo 5000 > "$RVE_CPU4s/down_rate_limit_us"
...
echo 257000000 > "$RVE_GPUf/max_freq"
...
#rvtuning "[$DATE]-[$TIME]Battery mode applied"